...
double LocalOmFclStateValidityCheckerR2::clearance(const ob::State *state) const
{
    const ob::RealVectorStateSpace::StateType *state_r2 = state->as<ob::RealVectorStateSpace::StateType>();
...
double LocalOmFclStateValidityCheckerR2::checkRiskZones(const ob::State *state) const
{
 ...
 */
double LocalOmFclStateValidityCheckerR2::checkSocialComfort(const ob::State *state,
...
double LocalOmFclStateValidityCheckerR2::basicPersonalSpaceFnc(const ob::State *state,
...
double LocalOmFclStateValidityCheckerR2::extendedPersonalSpaceFnc(const ob::State *state,
                                                                  const pedsim_msgs::AgentState agentState,
                                                                  const ob::SpaceInformationPtr space) const
{
    const ob::RealVectorStateSpace::StateType *state_r2 = state->as<ob::RealVectorStateSpace::StateType>();
...
bool LocalOmFclStateValidityCheckerR2::isRobotInFront(const ob::State *state,
                                                      const pedsim_msgs::AgentState agentState,
                                                      const ob::SpaceInformationPtr space) const
...
bool LocalOmFclStateValidityCheckerR2::isAgentInRFOV(const pedsim_msgs::AgentState agentState) const
